...
public class ControllerLoggingAspect {
     ...
     */
    @AfterReturning(pointcut = "execution(* com.yelisieiev.project.controller.UserController.*(..))", returning = "result")
     ...
     */
    @AfterReturning(pointcut = "execution(* com.yelisieiev.project.controller.EmployeeController.*(..))", returning = "result")
     ...
     */
    @AfterReturning(pointcut = "execution(* com.yelisieiev.project.controller.WebController.*(..))", returning = "result")
